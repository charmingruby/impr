...
type AuditLog struct {
	...
	DispatchedAt  *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=dispatched_at,json=dispatchedAt,proto3" json:"dispatched_at,omitempty"`
...
func (x *AuditLog) GetContext() string {
	if x != nil {
		return x.Context
	}
	return ""
...
func (x *AuditLog) GetSubject() string {
	if x != nil {
		return x.Subject
	}
	return ""
...
func (x *AuditLog) GetDispatchedAt() *timestamppb.Timestamp {
	if x != nil {
...
var file_audit_proto_rawDesc = string([]byte{
	0x0a, 0x0b, 0x61, 0x75, 0x64, 0x69, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x64,
	0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x1a, 0x1f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa9, 0x01, 0x0a, 0x08, 0x41, 0x75, 0x64, 0x69, 0x74,
	...
	0x41, 0x74, 0x42, 0x12, 0x5a, 0x10, 0x6c, 0x69, 0x62, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f,
...
var file_audit_proto_goTypes = []any{
	(*AuditLog)(nil),              // 0: domain.AuditLog
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_audit_proto_depIdxs = []int32{
	1, // 0: domain.AuditLog.dispatched_at:type_name -> google.protobuf.Timestamp
